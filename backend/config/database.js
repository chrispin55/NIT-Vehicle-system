...
let demoData = {
  users: [
    ...
    { id: 3, username: 'driver', email: 'driver@nit.ac.tz', password_hash: '$2a$10$rOzJqQjQjQjQjQjQjQjQjOzJqQjQjQjQjQjQjQjQjQjQjQjQjQjQjQjQjQjQjQjQ', role: 'driver', is_active: true, created_at: new Date() }
  ],
  vehicles: [
...
// Mock database connection for Render
